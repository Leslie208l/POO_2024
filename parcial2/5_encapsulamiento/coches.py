...
class Coches:
    ...
    #Nota1 Para utilizar un atributo privado es necesario hacer lo a travez de un metodo publico
    ...
    #Para utilizar un metodo privado es necesario hacerlo dentro de un metodo publico
